...
%\usepackage{booktabs} % for toprule or something
...
以上生成含雾图片的方法影响了许多后续研究，这让大规模含雾—无雾图片对的获取成为可能，是一项开创性的工作。在此基础上，Li[21]等人提出了RESIDE数据集—一个去雾算法学习评估的基准数据集，下面会介绍。
...
给公式、图片、目录加超链接？ it is just a label and a ref
